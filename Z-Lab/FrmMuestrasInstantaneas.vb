...
Public Class FrmMuestrasInstantaneas
    ...
    Private Sub llenar_datagridviewmuestras()   'cargar DataGrid de Preparacion Daily
        Try
            ...
            Dim da As New SqlDataAdapter
            Dim sql As String
            sql = "SELECT   id,  fecha, hora, TipoMuestra ,tipomuestra , ubicacion, tenor, Observaciones    FROM PB_Instantaneas WHERE    (Fecha = '" & CDate(DtFecha.Value) & "') ORDER BY hora "
            'sql = "SELECT   id,  fecha, hora, TipoMuestra ,tipomuestra , ubicacion, tenor, Observaciones  FROM PB_Instantaneas   "
            ...
            DgVMuestras.ReadOnly = False
            DgVMuestras.Columns("id").Visible = False
